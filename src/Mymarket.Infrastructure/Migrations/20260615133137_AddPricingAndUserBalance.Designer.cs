...
namespace Mymarket.Infrastructure.Migrations
{
    ...
    [Migration("20260615133137_AddPricingAndUserBalance")]
    partial class AddPricingAndUserBalance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mymarket.Domain.Entities.FavoritesEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Mymarket.Domain.Entities.ListingServicePriceEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("OriginalPricePerDay")
                        .HasPrecision(18, 2)
                    ...
                    b.HasIndex("ServiceType", "FromDay", "ToDay")
                        .IsUnique();

                    b.ToTable("ListingServicePrices", (string)null);
            ...
            modelBuilder.Entity("Mymarket.Domain.Entities.PermissionEntity", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 21,
                            Name = "HomeCategoriesView"
                        },
                        new
                        {
                            Id = 22,
                            Name = "HomeCategoriesAdd"
                        },
                        new
                        {
                            Id = 23,
                            Name = "HomeCategoriesEdit"
                        },
                        new
                        {
                            Id = 24,
                            Name = "HomeCategoriesDelete"
                        },
                        new
                        {
                            Id = 25,
                            Name = "HomeCategoriesReorder"
                        },
                        new
                        {
                            Id = 41,
                        ...
                        {
                            Id = 101,
                            Name = "AttributeOptionsView"
                        },
                        new
                        {
                            Id = 102,
                            Name = "AttributeOptionsAdd"
                        },
                        new
                        {
                            Id = 103,
                            Name = "AttributeOptionsEdit"
                        },
                        new
                        {
                            Id = 104,
                            Name = "AttributeOptionsDelete"
                        },
                        new
                        {
                            Id = 121,
            ...
            modelBuilder.Entity("Mymarket.Domain.Entities.RoleEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Mymarket.Domain.Entities.UserExternalLoginEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Mymarket.Domain.Entities.ChatMessageEntity", b =>
                {
                    b.HasOne("Mymarket.Domain.Entities.ChatEntity", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mymarket.Domain.Entities.UserEntity", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("RolePermissions", b =>
                {
                    b.HasOne("Mymarket.Domain.Entities.PermissionEntity", null)
                        .WithMany()
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mymarket.Domain.Entities.RoleEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UserRoles", b =>
                {
                    ...
                    b.HasOne("Mymarket.Domain.Entities.UserEntity", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
