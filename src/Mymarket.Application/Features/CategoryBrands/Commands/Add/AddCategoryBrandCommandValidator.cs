...
public class AddCategoryBrandCommandValidator : AbstractValidator<AddCategoryBrandCommand>
{
    private readonly IApplicationDbContext _context;

    public AddCategoryBrandCommandValidator(IApplicationDbContext context)
    {
        _context = context;
